            ...
            apiUrl === "vbt06"
              ...
              : apiUrl === "vbt07"
                ...
                : apiUrl === "vbt01"
                  ...
                  : apiUrl === "vbt08"
                    ? `Being FG material purchase for __ on INV no. ${pageHeaders?.invoiceId} date: __ amount: _ TDS:_ payable amt: _ `
                    : apiUrl === "vbt09"
                      ? `Being FG purchased on INV no. ${pageHeaders?.invoiceId} date: ___ amount: ___ TDS:___ payable amt: ____`
                      : apiUrl === "vbt02"
