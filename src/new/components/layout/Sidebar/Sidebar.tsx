...
const Sidebar = ({
  ...
  const [isSecondSidebarOpen, setIsSecondSidebarOpen] = useState<boolean>(false);
  const [isSecondSidebarCollapsed, setIsSecondSidebarCollapsed] = useState<boolean>(false);
  ...
  const renderList = (arr: AnyItem[], alwaysShowText = false, isSubMenu = false) => {
    const shouldShowText = isSubMenu ? alwaysShowText && !isSecondSidebarCollapsed : showSideBar;
  ...
  const subSidebarOpen = hoveredItem && hoveredItem.children && isSecondSidebarOpen;
          ...
          >
             <span
               style={{
                 ...
                 transform: !isSecondSidebarCollapsed ? "translateX(0)" : "translateX(-10px)",
                 transition: "all 0.3s ease",
                 whiteSpace: "nowrap",
                 overflow: "hidden",
               }}
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              ...
              >
                <span
                  style={{
                    transform: isSecondSidebarCollapsed ? "rotate(180deg)" : "rotate(0deg)",
                    transition: "transform 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
                    display: "inline-block",
                  }}
                >
