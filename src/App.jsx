    ...
    <div id="development_status">
      <div>
        <div style={{ position: "relative", height: "100vh" }}>
          <div class="highlight-development-mode-container">
                ...
                <Layout style={{ height: "100%" }}>
                  ...
                  >
                    <Row style={{ width: "100%" }} justify="space-between">
                      <Space size="large">
                        ...
                        <div className="location-select">
                          <Select
                            ...
                            onChange={(value) =>
                              handleSelectCompanyBranch(value)
                            }
                      ...
                      >
                        {user?.type &&
                          user?.type.toLowerCase() == "developer" && (
                            <>
                              <Switch
                                loading={testToggleLoading}
                                checked={testPage}
                                onChange={(value) =>
                                  handleChangePageStatus(value)
                                }
                          ...
                          <Badge
                            ...
                            style={{
                              background: notifications.filter(
                                (not) =>
                                  not?.loading || not?.status == "pending"
                              )[0]
                                ? "#EAAE0F"
                                : "green",
                            }}
